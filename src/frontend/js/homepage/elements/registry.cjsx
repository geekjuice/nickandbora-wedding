define [
  ...
  CNB = 'http://www.crateandbarrel.com/Gift-Registry/bora-lee-and-nicholas-hwang/r5239754'
  ZOLA = 'https://www.zola.com/registry/boraandnick'
  ...
  RegistryApp = React.createClass
    ...
    render: ->
      <div className='NickAndBora-registry'>
        ...
        <section>
          <a href={CNB} target='_blank'>
            <img className='cnb' src='/img/registry/cnb.png' />
          </a>
          <a href={ZOLA} target='_blank'>
            <img className='zola' src='/img/registry/zola.png' />
          </a>
          <h3>Dear friends and family,</h3>
          <p>We registered! Yes, we (as in <em>Bora</em>) made a trip to <a href={CNB} target='_blank'>Crate and Barrel</a> and added the entire store and we (as in <em>Bora</em>) accumulated various items. We also used <a href={ZOLA} target='_blank'>Zola Registry</a> to add in group gifting options.</p>
          ...
          <ol>
            ...
            <li>
              <p>2. Visit <a href={CNB} target='_blank'>www.CrateAndBarrel.com</a> to check out our registry. On the bridal & gift registry page, search for <em>Bora Lee</em> or <em>Nicholas Hwang</em>.</p>
              <p>For group gifting, visit <a href={ZOLA} target='_blank'>www.Zola.com</a> to check out our registry from various stores.</p>
