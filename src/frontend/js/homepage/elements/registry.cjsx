    ...
    render: ->
      <div className='NickAndBora-registry'>
        ...
        <section>
          ...
          <p>We registered! Yes, we (as in <em>Bora</em>) made a trip to <a href='http://www.crateandbarrel.com/gift-registry/' target='_blank'>Crate and Barrel</a> and added the entire store and we (as in <em>Bora</em>) accumulated various items.</p>
